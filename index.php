	...
	<?php $title = "Victim - Главная"; $page = 'index'; include('includes/header.php'); ?>
		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<h1>Экспертное юридическое решение</h1>
									<h2>текст <a href="#" target="_blank">текст/линк</a></h2>
		   	...
		   	<li style="background-image: url(../../images/img_bg_3.jpg);">
		   		...
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<h1>Защитите свое конституционное право с помощью юридической помощи</h1>
									<h2>Текст <a href="#" target="_blank">текст/линк</a></h2>
									<p><a class="btn btn-primary btn-lg btn-learn" href="#">Make An Appointment</a></p>
			   				</div>
			   			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 text-center animate-box">
					...
					<span class="fh5co-counter-label">Довольных клиентов</span>
				</div>
				<div class="col-md-3 text-center animate-box">
					...
					<span class="fh5co-counter-label">Завершенных дел</span>
				</div>
				<div class="col-md-3 text-center animate-box">
	...
	<div id="fh5co-content">
		<div class="video fh5co-video" style="background-image: url(images/T995e7NHTFpKNj3RCC9pBT1Q2NtqOote.jpg);">
			<a href="https://www.youtube.com/watch?v=DN3ToUySWzE" class="popup-vimeo"><i class="icon-video2"></i></a>
			<div class="overlay"></div>
		</div>
		<div class="choose animate-box">
			<div class="fh5co-heading">
				<h2>Почему именно мы?</h2>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing eolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
			</div>
			<div class="progress">
